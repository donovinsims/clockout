        ...
        <div className="math__card">
          ...
          <div className="math__result">
            <div>
              ...
              <p className="math__stat-num tnum">${fmt(monthlyLost)}</p>
            </div>
            <div>
              <p className="math__stat-label">Lost / year</p>
              <p className="math__stat-num tnum">${fmt(yearlyLost)}</p>
            </div>
          </div>
        </div>
    ...
    <section className="how" aria-labelledby="how-h">
      ...
      <div className="how__steps">
        <div className="how__step">
          <p className="how__num tnum">01 / Assessment</p>
          <h3 className="how__h">Get a Free Assessment.</h3>
          <p className="how__p">
            We find your exact revenue leaks. You get a written ROI report showing how much cash you're leaving on the table. No pitch, just plain math.
          </p>
        </div>
        <div className="how__step">
          <p className="how__num tnum">02 / Install</p>
          <h3 className="how__h">Flat-Fee Install (3–7 Days).</h3>
          <p className="how__p">
            We build and deploy the fix. One flat price, known upfront. It runs quietly in the background without changing how you work.
          </p>
        </div>
        <div className="how__step">
          <p className="how__num tnum">03 / Freedom</p>
          <h3 className="how__h">Get Your Evenings Back.</h3>
          <p className="how__p">
            You stop bleeding cash and get your time back. We hand over the keys—you own the system outright. No monthly software retainers.
          </p>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="guarantee" aria-labelledby="guar-h">
      <div className="guarantee__card">
        <p className="guarantee__eyebrow">The 30-Day ROI Guarantee</p>
        <h2 className="guarantee__h" id="guar-h">
          It pays for itself in 30 days, <em>or we work for free.</em>
        </h2>
        <p className="guarantee__p">
          We install your system in 7 days. If it doesn't generate enough recovered revenue or saved time to pay for itself within 30 days, we keep working for free until it does. Zero risk.
        </p>
        <CalModal>
...
const FAQS = [
  {
    ...
    a: "No. You don't have to learn any new software or log into any dashboards. We build the automation so it runs in the background. You just keep answering your phone and doing the work—the system handles the rest.",
  },
  {
    q: "I don't have time to set this up.",
    a: "You don't set anything up. We do 100% of the heavy lifting. All we need is a 20-minute call to understand your leak, and we handle the build, testing, and deployment. You get back to work.",
  },
  {
    q: "Is this AI?",
  ...
  },
  {
    ...
    a: "We install in 7 days. If it hasn't paid for itself in 30 days, we keep working for free until it does. That's the deal.",
  },
  {
  ...
  return (
    <section className="hero" id="top" aria-labelledby="hero-h" ref={ref}>
      ...
      <h1 className="hero__display" id="hero-h">
        <span className="hero__line">End the chaos.</span>
        <span className="hero__line">Stop losing jobs.</span>
        <span className="hero__line">
          <em>Get your evenings back.</em>
        </span>
      </h1>
