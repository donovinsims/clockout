...
export function HowItWorks({ slug }: { slug?: string }) {
  const stepArtifacts = [
    ...
    // 02 — Build
    {
      ...
      body: "24/7 front desk, missed-call rescue, quote follow-up, review pipeline, reactivation flows. Installed in your stack. Your team gets zero new logins. You own every login and line of code.",
      artifact: (
