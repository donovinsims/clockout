        ...
        <div className="mt-10 grid gap-px overflow-hidden rounded-xl border border-line bg-line md:grid-cols-3">
          <div className="bg-background p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Donovin ran Product Operations at Uber (real-time dispatch, 50K+
              attendees) and shipped digital products at Walgreens. Now bringing
              that discipline to local trade shops at a flat price.
            </p>
          </div>
          ...
          <div className="bg-background p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              If the system doesn't give you 10 hours back every week within 30
              days, I keep working until it does. Free. No fine print.
            </p>
          </div>
          ...
          <div className="bg-background p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              <BetaSpots /> Each beta client gets a full build at a fraction of
              the future price in exchange for a documented case study.
            </p>
          </div>
        </div>
