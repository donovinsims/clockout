  ...
  head: () => ({
    meta: [
      { title: "Free 20-Minute Revenue-Leak Audit \u2014 Clockout" },
      {
        name: "description",
        content:
          "Book a free 20-minute call. I'll show you exactly where your business is leaking money \u2014 and send you your Money-Leak Map to keep, whether you hire me or not.",
      },
...
const leakCategories = [
  {
    title: "Missed calls",
    body: "Every call you can't grab on a roof or under a sink is a job walking to the next guy.",
    figure: "~$5,400/mo",
  },
  {
    title: "After-hours drop-off",
    body: "Nights and weekends ring out to a voicemail nobody checks until Monday.",
    figure: "~$2,800/mo",
  },
  {
    title: "Slow quote follow-up",
    body: "Quotes sent, then silence \u2014 20\u201335% are recoverable with follow-up alone.",
    figure: "~$3,200/mo",
  },
  {
    title: "Manual admin & dispatch",
    body: "The hours you burn Sunday night on data entry instead of living your life.",
    figure: "~$1,950/mo",
  },
];
...
function AssessmentPage() {
  ...
  return (
    <SiteShell stickyCta={false} leadMagnet={false}>
      ...
      <section className="relative border-b border-line">
        ...
        <div className="container-x relative py-20 md:py-28">
          ...
          <p className="mt-7 max-w-2xl text-lg text-foreground/80">
            Tell me a few things about your shop and grab a time. Before we talk, I'll dig into your
            business — then on a quick 20-minute call I'll show you exactly where you're losing jobs
            and dollars: the missed calls, the quotes going cold, the follow-ups that never happen.
            A day later, you get your Money-Leak Map in writing — yours to keep, whether you hire me
            or not.
          </p>
          <div className="mt-8">
            <a
        ...
        <div className="container-x">
          ...
          <div className="mt-8 grid gap-px overflow-hidden rounded-2xl border border-line bg-line md:grid-cols-3">
            <div className="bg-background p-7">
              <p>
                On the call: a live walkthrough of exactly where you're losing money, in real
                dollars — not vague "you should use AI" advice.
              </p>
            </div>
            <div className="bg-background p-7">
              <p>
                A day later: your Money-Leak Map — your biggest leaks, ranked, and the first one I'd
                plug. Keep it forever.
              </p>
            </div>
            <div className="bg-background p-7">
              <p>
          ...
          <p className="mt-6 text-sm text-dim">
            I can't hand you this before we talk — I don't know your business yet. The call is how I
            earn the right to give it to you.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-line py-20 md:py-28">
        <div className="container-x">
          <h2 className="max-w-3xl text-4xl md:text-5xl">Here's what I'm hunting for</h2>
          ...
          <p className="mt-6 text-sm text-dim">
            Ranges for a shop your size, based on industry data (ServiceTitan, PMI). Your real
            number comes out on the call — that's what the Map is for.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-line py-20 md:py-28">
        <div className="container-x">
          <h2 className="max-w-3xl text-4xl md:text-5xl">How it works, start to finish</h2>
          <ol className="mt-8 grid gap-px overflow-hidden rounded-2xl border border-line bg-line md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { n: "02", t: "Grab a time", b: "You'll jump straight to my calendar." },
              {
                n: "03",
                t: "I do my homework",
                b: "I dig into your business before we ever talk.",
              },
              {
                n: "04",
                t: "The 20-minute call",
                b: "I show you the leaks in dollars — then send your Money-Leak Map.",
              },
            ].map((s) => (
      ...
      <section id="form" className="border-b border-line py-20 md:py-28">
        <div className="container-x">
          ...
          <p className="mt-4 text-center text-xs text-dim">
            You'll go straight to my calendar to pick a time. I'll never share your info — no spam,
            ever.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-line py-20 md:py-28">
        <div className="container-x">
          <h2 className="max-w-3xl text-4xl md:text-5xl">Straight answers</h2>
        ...
        <div className="container-x">
          <blockquote className="mx-auto max-w-2xl text-center">
            <p className="text-xl italic text-foreground/80">
              "It\u2019s saved me 10+ hours a week\u2026 complex operations, simplified and
              automated. Exactly who you want building it."
            </p>
            <footer className="mt-4 text-sm text-dim">\u2014 Shea S., Founder</footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="container-x text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-foreground/80">
            If we get on the call and I can't point to real money you're leaving on the table, I'll
            be shocked — and you keep the Map anyway. You're risking 20 minutes.
          </p>
          <div className="mt-8">
            <a
              href="#form"
