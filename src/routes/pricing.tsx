...
const compareRows: { label: string; them: string; us: string }[] = [
  { label: "Pricing", them: "$797\u2013$5,000/mo, forever", us: "Free audit \u00b7 $497 one-time build \u00b7 concierge only if you want it" },
  { label: "Contract", them: "12 months, locked in", us: "None. Cancel any month." },
  { label: "Ownership", them: "They keep it \u2014 leave and it's gone", us: "You own everything: logins, code, docs" },
  { label: "If you stop paying", them: "It all shuts off", us: "You keep every automation" },
  { label: "Install time", them: "2\u20136 weeks", us: "Days" },
  { label: "Guarantee", them: "60-day refund, fine print", us: "10 hours a week back in 30 days, or I keep working" },
];
...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing \u2014 Clockout \u00b7 Start free \u00b7 Own what I build \u00b7 No contracts" },
      { name: "description", content: "Start with a free audit. Pay once for the build and own everything. Keep me on as your concierge only if you want \u2014 month to month, cancel anytime." },
      { property: "og:title", content: "Pricing \u2014 Start free. Own what I build. No contracts." },
      { property: "og:description", content: "Free audit. One-time build. Month-to-month concierge. You own everything." },
    ],
  }),
      ...
      <section className="border-b border-line py-20 md:py-28">
        <div className="container-x">
          ...
          <p className="mt-6 max-w-2xl text-lg text-foreground/80">
            No rented software. No 12-month lock-in. No dashboard you'll never log into. You start with a free audit, pay once to get it built (and own every bit of it), and keep me on only if it's worth it to you &mdash; cancel any month.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-line py-20 md:py-28">
        <div className="container-x">
          ...
          <h2 className="max-w-3xl text-4xl md:text-5xl">
            Three steps. Stop wherever you want.
          </h2>
          <div className="mt-10 grid gap-px overflow-hidden rounded-2xl border border-line bg-line md:grid-cols-3">
            ...
            <div className="bg-background flex flex-col p-7">
              ...
              <div className="mt-2">
                <span className="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary">Free</span>
              </div>
              ...
              <ul className="mt-4 flex-1 space-y-3 text-sm text-foreground/80">
                <li className="flex items-start gap-2">
                  <span className="mt-1 block h-1 w-1 rounded-full bg-primary/60 shrink-0" />
            ...
            <div className="bg-background flex flex-col p-7 md:-mx-px md:scale-105 md:rounded-2xl md:border md:border-primary/30 md:bg-surface md:shadow-[0_0_40px_-16px_color-mix(in_oklab,var(--color-primary)_25%,transparent)]">
              ...
              <div className="mt-2">
                <span className="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary">${BETA} beta (reg. ${STANDARD}) &middot; one-time &middot; you own it</span>
              </div>
              <ul className="mt-4 flex-1 space-y-2 text-sm text-foreground/80">
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />24/7 missed-call text-back + AI front desk &mdash; catches the calls you miss on a job (answering services run $300&ndash;$800/mo)</li>
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />Quote follow-up engine &mdash; chases every quote at 1 hour, 1 day, 3 days, 7 days; recovers 20&ndash;35% that would've gone cold</li>
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />Automatic review engine &mdash; turns happy jobs into Google reviews on autopilot (reputation tools run $50&ndash;$150/mo)</li>
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />Past-customer reactivation &mdash; wakes up the list you haven't called in a year</li>
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />Owner dashboard &mdash; calls answered, quotes recovered, hours saved, in real numbers</li>
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />30 days of tuning after handover</li>
                <li className="flex items-start gap-2"><span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />Your Money-Leak Map from the audit</li>
              </ul>
            ...
            <div className="bg-background flex flex-col p-7">
              ...
              <div className="mt-2">
                <span className="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary">${CONCIERGE}/mo &mdash; founding rate, locked for life &middot; cancel anytime</span>
              </div>
              <p className="mt-4 text-sm text-foreground/75 italic">
              ...
              <ul className="mt-4 flex-1 space-y-3 text-sm text-foreground/80">
                <li className="flex items-start gap-2">
                  <span className="mt-1 block h-1 w-1 rounded-full bg-primary/60 shrink-0" />
                  I stay on as your AI operator &mdash; a new automation every couple weeks, biweekly build sessions, on call between, and a running log of everything we've built. You still own all of it. Month to month. Cancel any time and keep everything.
                </li>
              </ul>
              <p className="mt-4 text-xs text-foreground/70 leading-relaxed">
                A marketing agency charges $2,200&ndash;$5,000/month to manage this and locks you into a year. Operator OS is $750/month, cancel any time, and you own everything we build.
              </p>
