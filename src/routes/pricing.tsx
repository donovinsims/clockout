...
import { PricingRung } from "@/components/site/PricingRung";
        ...
        <div className="container-x">
          ...
          <div className="mt-10 grid gap-px overflow-hidden rounded-2xl border border-line bg-line md:grid-cols-3">
            ...
            <PricingRung
              ...
              quote="\u201CI think I'm losing money but I don't know where.\u201D"
              features={
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="mt-1 block h-1 w-1 rounded-full bg-primary/60 shrink-0" />A
                    20-minute call where I show you exactly where you&rsquo;re leaking jobs and
                    dollars, plus your Money-Leak Map &mdash; your biggest leaks ranked, with the
                    first one I&rsquo;d fix. Yours to keep, hire me or not.
                  </li>
                </ul>
              }
              cta={
                ...
                <>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      24/7 missed-call text-back + AI front desk &mdash; catches the calls you miss
                      on a job (answering services run $300&ndash;$800/mo)
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />
                      Automatic review engine &mdash; turns happy jobs into Google reviews on
                      autopilot (reputation tools run $50&ndash;$150/mo)
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />
                      Past-customer reactivation &mdash; wakes up the list you haven't called in a
                      year
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 block h-1 w-1 shrink-0 rounded-full bg-primary/60" />
                  ...
                  <p className="mt-4 text-xs text-foreground/70 leading-relaxed">
                    A GoHighLevel or marketing agency charges $797&ndash;$1,497 every month to run
                    this same stack &mdash; and you never own it. The Build is ${BETA}, once. You
                    own all of it, and it keeps running the day you stop paying. Three missed calls
                    a week at a $450 ticket is $5,400 walking out the door every month &mdash; the
                    kind of number I turn up in a real audit. The fix is a one-time ${BETA}.
                  </p>
                </>
              }
              cta={
            ...
            <PricingRung
              eyebrow="RUNG 3"
              title="Operator OS Concierge"
              price={
                <span className="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
                  ${CONCIERGE}/mo &mdash; founding rate, locked for life &middot; cancel anytime
                </span>
              }
              quote="\u201CI'd rather keep a pro in my corner than babysit this myself.\u201D"
              features={
                <>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <span className="mt-1 block h-1 w-1 rounded-full bg-primary/60 shrink-0" />I
                      stay on as your AI operator &mdash; a new automation every couple weeks,
                      biweekly build sessions, on call between, and a running log of everything
                      we've built. You still own all of it. Month to month. Cancel any time and keep
                      everything.
                    </li>
                  </ul>
                  <p className="mt-4 text-xs text-foreground/70 leading-relaxed">
                    A marketing agency charges $2,200&ndash;$5,000/month to manage this and locks
                    you into a year. Operator OS is $750/month, cancel any time, and you own
                    everything we build.
                  </p>
                  <p className="mt-2 text-xs text-foreground/60">
                    First two weeks free if I stall: if I don't ship a working automation in your
                    first two weeks, that month's on me.
                  </p>
                  <p className="mt-2 text-xs text-foreground/50 italic">
                    Note: You only get here after the build &mdash; never a forced upsell. You
                    decide once you've seen the work.
                  </p>
                </>
              }
              cta={
